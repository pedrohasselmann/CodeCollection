...
c    
      ...
      x   = 0.7
      z   = 0.02
c      print *, 'Para calcular o modelo de interior estelar entre com'
c      print *, 'os seguintes dados da estrela'
c      print *, ' ' 
c      print *, 'Massa em unidades solares:'
c      read(*,*) vm0
c      print *, 'Raio em unidades solares:'
c      read(*,*) r0
c      print *, 'Luminosidade em unidades solares:'
c      read(*,*) vl0
c      print *, 'Temperatura efetiva em kelvin:'
c      read(*,*) t0
c      print *, 'Densidade na superficie em g/cm3:'
c      read(*,*) d0
c      print *, 'Massa percentual de H:'
c      read(*,*) x
c      print *, 'Massa percentual de metais:'
c      read(*,*) z
c     
...
c
      ...
      write(1,*) '       raio     massa        dens        press    
     1temp        lumin  transp'
      write(2,*) '   raio       pgas        prad      epspp      epscno
     1   epstot'
      write(3,*) '   raio      kapbf      kapff      sigmae      kaptot'
c
...
300   format(5(1x,D10.3))

c
      write(2,200)radius,pressg,pressrad,eps1*eps2,eps3,eps1*eps2+eps3
      write(3,300)radius,vkbf,vkff,sigma_e,vkappat
